    ...
    public class AtendimentosController : ControllerBase
    {
        ...
        public ActionResult<AtendimentoResponseDTO> Put([FromBody] AtendimentoRequestDTO atendimentoUpdateDTO)
        {
            try
            {
                ...
                var medicoModel = _atendimentoMedicoContext.Medico.Where(x => x.Id == atendimentoUpdateDTO.IdMedico).FirstOrDefault();
                if (medicoModel == null)
                ...
                var pacienteModel = _atendimentoMedicoContext.Paciente.Where(x => x.Id == atendimentoUpdateDTO.IdPaciente).FirstOrDefault();
